...
awful.util.tagnames = { "t1", "t2", "w1", "w2", "p", "m" }
...
globalkeys = mytable.join(
    -- Take a screenshot
    awful.key({ }, "Print", function() awful.spawn("gnome-screenshot -ia") end,
              {description = "take a screenshot", group = "launcher"}),


    -- Start emacs
    awful.key({ altkey, "Control" }, "e", function() awful.spawn("emacsclient -c --alternate-editor=''") end,
    ...
    awful.key({ }, "XF86AudioPlay",
       ...
       end, {description = "toggle play/pause", group = "hotkeys"}),
    ...
    awful.key({ }, "XF86AudioStop",
       ...
       end, {description = "stop", group = "hotkeys"}),
